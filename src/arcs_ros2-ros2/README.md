...
ROS2 stack for **AUBO collaborative education robots**. This package contains launch and configuration setups to quickly get started using the driver.
...
If you find an issue with the package you are not able to fix yourself, please [open an issue on Git](https://gitee.com/aubo-nxrobo/arcs_ros2/issues/new) or open a PR with proposed changes.
...
4. Pull relevant packages, install dependencies, compile, and source the workspace by using:
    ...
    ```
**NOTE:** The `aubo_ros2.repos` file contains moveit2 src links to ros2 packages that need to be source-built to use their newest features.If build [quit](https://github.com/moveit/moveit2/issues/2083),please limited to 1 by selecting the sequential executor with `--executor sequential`.
