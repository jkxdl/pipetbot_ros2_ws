...
def generate_launch_description():
    ...
    # 当前包名
    this_package = "pipettingrobot_sim"

    default_robot_name = "pipetting_robot"
    ...
    start_gazebo_server_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            "world": os.path.join(
                this_pkg_share, "worlds", "pipetting.world"
            )
        }.items(),
    )
    # Start Gazebo client
    ...
    doc = xacro.parse(open(os.path.join(this_pkg_share, "urdf", "pipettingrobot.urdf.xacro")))
    ...
    start_arm_trajectory_controller_cmd = Node(
        package="controller_manager",
        executable="spawner",
        arguments=[
    ...
    load_arm_trajectory_controller_cmd = RegisterEventHandler(
        event_handler=OnProcessExit(
            target_action=start_joint_state_broadcaster_cmd,
            on_exit=[start_arm_trajectory_controller_cmd],
        )
    )
    ...
    ld.add_action(load_arm_trajectory_controller_cmd)
